        ...
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                IF RecVenLedEntry."Document Type" = RecVenLedEntry."Document Type"::Invoice THEN BEGIN
                    ...
                    // 15578 "UTR No." As Discussed With Jaideep Please Comment      RecPIComment.SetRange("User Type", RecPIComment."User Type"::Finance);
                ...
                IF RecVenLedEntry."Document Type" = RecVenLedEntry."Document Type"::Payment THEN BEGIN
                    ...
                    // 15578 "UTR No." As Discussed With Jaideep Please Comment    UTRNo := RecVenLedEntry."UTR No.";
                ...
                if UTRNo = '' then begin
                    ...
                    if RecBankAccountLedEntry.FindFirst then
                        // 15578 "UTR No." As Discussed With Jaideep Please Comment    if RecBankAccountLedEntry."Payment Type" = RecBankAccountLedEntry."Payment Type"::Cheque then
        ...
        IF EntryNo <> 0 THEN BEGIN
            IF STRPOS(Entry_No, FORMAT(EntryNo)) = 0 THEN BEGIN
                ...
                IF VenLedEntry.FINDFIRST THEN BEGIN
                    ...
                    IF "Vendor Ledger Entry"."Document Type" <> "Vendor Ledger Entry"."Document Type"::Payment THEN BEGIN
                        // 15578 "UTR No." As Discussed With Jaideep Please Comment  RecVenLedEntry."UTR No." := VenLedEntry."UTR No."; //UTR No
